...
# Same width choices as in your previous code
...
def reg_func(x):
    """
    Regression function from your synthetic example.
    """
...
def module_state_dict_cpu(module):
    """
    Store a CPU copy of the fitted f2 parameters.
    """
...
# ============================================================
# Generate data and construct MI, MF, II datasets
# ============================================================

def generate_and_impute_data(random_state=1):
    """
    Generate the synthetic data and construct:

        Z_MI: mean-imputed data
        Z_MF: MissForest-imputed data
        Z_II: IterativeImputer-imputed data
        Omega: observation pattern
        Y: response

    This follows the structure of your original code.
    """
...
def fixed_split(data):
    """
    Same fixed split as in your original synthetic-data code:
...
def train_penn_one_sparsity(
    ...
    """
    Train one PENN at a fixed pruning level.
    """
...
def train_best_penn_by_validation(
    ...
    """
    Train one PENN for each pruning level and choose the one
    with the smallest validation MSE.
    """
...
def extract_f2_embeddings(
    ...
    """
    Extract self.f2(Omega) for training, validation and test data.
    """
