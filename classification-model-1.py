...
print(f'Complete={np.array2string(ER_Complete, separator=', ')}')
...
print(f'MICE={np.array2string(ER_MICE, separator=', ')}')



# with open('C:/Users/tm681/Desktop/DNN missing data/output.txt', 'w') as file:
#     # Write text to the file
#     file.write('This is the output text that will be saved.\n')
#     file.write('Another line of text can be added here.')