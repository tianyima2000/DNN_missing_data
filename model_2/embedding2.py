...
def reg_func(x):
    """
    Regression function from model_6.
    """
...
def generate_and_impute_data(random_state=1):
    """
    Generate the synthetic model_6 data and construct MI, MF, II datasets.

    Missingness is MNAR because Omega[:, 2] and Omega[:, 3]
    depend directly on X[:, 2] and X[:, 3].
    """
