...
with open("/home/tm681/DNN_missing_data/credit_score_prediction/credit_score_data.pkl", 'rb') as f:
    data = pickle.load(f)
...
def one_run():
    Z_train, Z_test, Z_MI_train, Z_MI_test, Z_MF_train, Z_MF_test, Z_II_train, Z_II_test, Omega_train, Omega_test, Y_train, Y_test = train_test_split(Z, Z_MI, Z_MF, Z_II, Omega, Y, test_size=0.1)
    Z_train, Z_val, Z_MI_train, Z_MI_val, Z_MF_train, Z_MF_val, Z_II_train, Z_II_val, Omega_train, Omega_val, Y_train, Y_val = train_test_split(Z_train, Z_MI_train, Z_MF_train, Z_II_train, Omega_train, Y_train, test_size=0.11111)
    ...
    return PENN_MI_loss / Y_test.var(unbiased=False).item(), NN_MI_loss / Y_test.var(unbiased=False).item(), PENN_MF_loss / Y_test.var(unbiased=False).item(), NN_MF_loss / Y_test.var(unbiased=False).item(), PENN_II_loss / Y_test.var(unbiased=False).item(), NN_II_loss / Y_test.var(unbiased=False).item(), xgb_test_mse / Y_test.var(unbiased=False).item()
