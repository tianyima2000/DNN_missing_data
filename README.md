...
# Tutorial
The complete code used in this tutorial can be found in the [Jupyter notebook](.Tutorial.ipynb). Here, we only focus on how to define the class of PENNs and how to train them. The required packages for this tutorial are `torch`, `numpy`, `matplotlib` and `scikit-learn`.
